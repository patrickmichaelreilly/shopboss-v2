...
// Modify the existing toggleProject function to initialize SmartSheet status
...
toggleProject = function(projectId) {
    ...
    // If project was just expanded (was hidden, now showing), initialize SmartSheet status
    if (wasHidden) {
